            ...
            <div className="container mx-auto px-6 lg:px-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="relative">
                        {/* Main Image */}
                        <div className="relative w-full aspect-[567/629] rounded-3xl overflow-hidden shadow-xl">
                            <Image
                            ...
                            <div className="absolute top-4/12 md:top-6/12 inset-0 flex flex-col justify-center items-start p-4  space-y-4">
